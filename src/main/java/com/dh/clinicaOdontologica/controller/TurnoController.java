...
public class TurnoController {
    ...
    public ResponseEntity<String> actualizarTurno(@RequestBody Turno turno) throws ResourceNotFoundException{
        ...
        if(turnoBuscado.isPresent()){
            ...
            logger.info("Cuidado. Se modificó el turno con ID= " + turno.getId());
    ...
    public ResponseEntity<String> eliminarTurno(@PathVariable Long id) throws ResourceNotFoundException {
        ...
        if(turnoBuscado.isPresent()){
            ...
            logger.info("Cuidado. Se eliminó el turno con ID: "+ id + " perteneciente al paciente con DNI: " + turnoBuscado.get().getPaciente().getDni());
